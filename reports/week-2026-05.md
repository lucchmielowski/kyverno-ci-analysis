...
![P95 Duration](./images/p95-duration-week-2026-05.png)

#### Flaky Rate Over Time (%)

![Flaky Rate](./images/flaky-rate-week-2026-05.png)

### End-User Experience (PR-Triggered Runs)

#### P95 Latency Over Time - PR Runs (minutes)

![P95 Duration - PR Runs](./images/p95-duration-pr-week-2026-05.png)

#### Flaky Rate Over Time - PR Runs (%)

![Flaky Rate - PR Runs](./images/flaky-rate-pr-week-2026-05.png)
